"""
Django settings for StudentForStudent project.
...
SECRET_KEY = 'django-insecure-5m)l)oo0w(eoixngk_lir$ybv%#adglkn@_k-mx!#!%=l8n(&o'
...
ROOT_URLCONF = 'StudentForStudent.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'S4S/../templates']
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'StudentForStudent.wsgi.application'
